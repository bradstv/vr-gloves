<script lang="ts" context="module">
	...
	export let description =
		'Move servos to test force feedback functionality. Value from 0 to 1000. Retracting servos fully means they should not apply any force on your fingers throughout curling your finger, while extending them fully means you should not be able to curl your fingers at all.';
</script>
